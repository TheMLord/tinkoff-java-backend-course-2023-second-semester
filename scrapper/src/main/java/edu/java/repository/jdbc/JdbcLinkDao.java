...
public class JdbcLinkDao implements LinkDao {
    ...
    public Link add(Long chatId, URI uri) {
        ...
        */
        try {
            ...
            return new Link(linkId, uri, null, null);
        } catch (Exception e) {
    ...
    public Link remove(Long chatId, URI uri) {
        var tgChatId = getChatIfExist(chatId).getChatId();
        var linkId = getLinkIfExist(uri).getId();
    ...
    private Link getLinkIfExist(URI uri) {
        return findLinkByLinkName(uri).orElseThrow(NotExistLinkException::new);
    }
     ...
     */
    private Optional<Link> findLinkByLinkName(URI uri) {
     ...
     */
    private List<Long> findAllIdTgChatWhoTrackLink(Long uriId) {
        return jdbcTemplate.query(

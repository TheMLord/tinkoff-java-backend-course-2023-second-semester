...
public class SubscriptionsRecord extends UpdatableRecordImpl<SubscriptionsRecord> implements Record4<Long, Long, OffsetDateTime, String> {
    ...
    @Override
    @NotNull
    public SubscriptionsRecord values(@NotNull Long value1, @NotNull Long value2, @NotNull OffsetDateTime value3, @Nullable String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public SubscriptionsRecord(@NotNull Long chatId, @NotNull Long linkId, @NotNull OffsetDateTime createdAt, @Nullable String createdBy) {
        super(Subscriptions.SUBSCRIPTIONS);

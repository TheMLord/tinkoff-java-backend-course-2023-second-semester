...
public class Links extends TableImpl<LinksRecord> {
     ...
     */
    public final TableField<LinksRecord, String> LINK_URI =
        createField(DSL.name("LINK_URI"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");

    /**
     * The column <code>LINKS.CREATED_AT</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> CREATED_AT =
     ...
     */
    public final TableField<LinksRecord, String> CREATED_BY = createField(DSL.name("CREATED_BY"),
        SQLDataType.VARCHAR(1000000000).nullable(false)
            .defaultValue(DSL.field(DSL.raw("'themlord'"), SQLDataType.VARCHAR)),
        this,
        ""
    );
     ...
     */
    public final TableField<LinksRecord, String> CONTENT =
        createField(DSL.name("CONTENT"), SQLDataType.VARCHAR(1000000000), this, "");

    /**
     * The column <code>LINKS.LAST_MODIFYING</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_MODIFYING = createField(DSL.name("LAST_MODIFYING"),
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function6<? super Long, ? super String, ? super OffsetDateTime, ? super String, ? super String, ? super OffsetDateTime, ? extends U> from
    ) {

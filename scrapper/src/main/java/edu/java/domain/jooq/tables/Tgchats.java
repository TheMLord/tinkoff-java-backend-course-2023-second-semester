...
public class Tgchats extends TableImpl<TgchatsRecord> {
     ...
     */
    public final TableField<TgchatsRecord, OffsetDateTime> CREATED_AT =
     ...
     */
    public final TableField<TgchatsRecord, String> CREATED_BY = createField(DSL.name("CREATED_BY"),

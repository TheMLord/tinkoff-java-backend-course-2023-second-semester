...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record6<Long, String, OffsetDateTime, String, String, OffsetDateTime> {
    ...
    @Override
    @NotNull
    public LinksRecord values(@Nullable Long value1, @NotNull String value2, @NotNull OffsetDateTime value3, @Nullable String value4, @Nullable String value5, @Nullable OffsetDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinksRecord(@Nullable Long id, @NotNull String linkUri, @NotNull OffsetDateTime createdAt, @Nullable String createdBy, @Nullable String content, @Nullable OffsetDateTime lastModifying) {
        super(Links.LINKS);

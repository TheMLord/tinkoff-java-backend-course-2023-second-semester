...
public class Subscriptions extends TableImpl<SubscriptionsRecord> {
     ...
     */
    public final TableField<SubscriptionsRecord, OffsetDateTime> CREATED_AT =
     ...
     */
    public final TableField<SubscriptionsRecord, String> CREATED_BY = createField(DSL.name("CREATED_BY"),
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function4<? super Long, ? super Long, ? super OffsetDateTime, ? super String, ? extends U> from
    ) {
